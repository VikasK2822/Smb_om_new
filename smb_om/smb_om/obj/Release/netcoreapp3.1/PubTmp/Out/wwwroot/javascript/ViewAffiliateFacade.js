...
(function() {
if (dwr.engine._getObject("ViewAffiliateFacade") == undefined) {
var p;
...
p.getAffiliateDetails = function(p0, callback) {
return dwr.engine._execute(p._path, 'ViewAffiliateFacade', 'getAffiliateDetails', arguments);
};
...
p.getGatewayUrl = function(p0, callback) {
return dwr.engine._execute(p._path, 'ViewAffiliateFacade', 'getGatewayUrl', arguments);
};
...
p.getPortalUrl = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'ViewAffiliateFacade', 'getPortalUrl', arguments);
};
...
return dwr.engine._execute(p._path, 'ViewAffiliateFacade', 'getSystemDate', arguments);
};

dwr.engine._setObject("ViewAffiliateFacade", p);
}
})();
