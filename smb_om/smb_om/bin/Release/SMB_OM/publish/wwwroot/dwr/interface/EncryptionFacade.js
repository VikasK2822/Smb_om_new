...
(function() {
if (dwr.engine._getObject("EncryptionFacade") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'EncryptionFacade', 'getSystemDate', arguments);
};
...
p.decryptValues = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'EncryptionFacade', 'decryptValues', arguments);
};
...
p.getSHA512Hash = function(p0, callback) {
return dwr.engine._execute(p._path, 'EncryptionFacade', 'getSHA512Hash', arguments);
};
...
p.decryptionRequested = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'EncryptionFacade', 'decryptionRequested', arguments);
};

dwr.engine._setObject("EncryptionFacade", p);
}
})();
