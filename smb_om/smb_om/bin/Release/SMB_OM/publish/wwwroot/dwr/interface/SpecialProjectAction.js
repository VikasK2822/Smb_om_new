...
(function() {
if (dwr.engine._getObject("SpecialProjectAction") == undefined) {
var p;
...
p.processSpecialProjectAction = function(p0, callback) {
return dwr.engine._execute(p._path, 'SpecialProjectAction', 'processSpecialProjectAction', arguments);
};
...
return dwr.engine._execute(p._path, 'SpecialProjectAction', 'getSystemDate', arguments);
};

dwr.engine._setObject("SpecialProjectAction", p);
}
})();
