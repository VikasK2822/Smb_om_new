...
(function() {
if (dwr.engine._getObject("SmsFacade") == undefined) {
var p;
...
p.resendLastSmS = function(p0, callback) {
return dwr.engine._execute(p._path, 'SmsFacade', 'resendLastSmS', arguments);
};
...
return dwr.engine._execute(p._path, 'SmsFacade', 'getSystemDate', arguments);
};

dwr.engine._setObject("SmsFacade", p);
}
})();
