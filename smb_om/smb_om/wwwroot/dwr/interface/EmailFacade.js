...
(function() {
if (dwr.engine._getObject("EmailFacade") == undefined) {
var p;
...
p.resendEmail = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'resendEmail', arguments);
};
...
return dwr.engine._execute(p._path, 'EmailFacade', 'sendEmail', arguments);
};
...
p.getHtmlEditorEmail = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'getHtmlEditorEmail', arguments);
};
...
p.getHtmlFromTemplateId = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'getHtmlFromTemplateId', arguments);
};
...
p.logEmailEntry = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'logEmailEntry', arguments);
};
...
p.resendLogEmailEntry = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'resendLogEmailEntry', arguments);
};




p.getSystemDate = function(callback) {
return dwr.engine._execute(p._path, 'EmailFacade', 'getSystemDate', arguments);
};

dwr.engine._setObject("EmailFacade", p);
}
})();
